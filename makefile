...
git-commit:
	...
	echo -e "\033[32mCommitting changes in \"FreydCategoriesForCAP\"\033[0m"; \
	git add .; \
	git commit \
		...
		echo -e "\033[33mNo changes in \"FreydCategoriesForCAP\" to commit or no version bump detected.\033[0m"; \
	fi
